 <div class="content-blocks about">
    <section class="content" id="about">
        <div class="block-content">
            ...
            <h3 class="subheading">I'm a <strong> Frontend Developer</strong> from Dublin, Ireland. I'm a part time Photographer who also has an interest in videography.</h3>
        ...
        <div class="block-content">
           ...
           <label class="progress-bar-label">Final Cut Pro X - <span>7 years experience</span></label>
            ...
            <label class="progress-bar-label">Wordpress - <span>1 year experience</span></label>
            <div class="progress">
                <div style="width: 55%;" class="progress-bar" role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100">
                    <span>55%</span>
                </div>
            </div>
            <label class="progress-bar-label">Photoshop - <span>7 years experience</span></label>
            <div class="progress">
                <div style="width: 49%;" class="progress-bar" role="progressbar" aria-valuenow="49" aria-valuemin="0" aria-valuemax="100">
                    <span>49%</span>
                </div>
            </div>
            <label class="progress-bar-label">Lightroom - <span>4 years experience</span></label>
            <div class="progress">
                <div style="width: 68%;" class="progress-bar" role="progressbar" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100">
                    <span>68%</span>
                </div>
            </div>

            <label class="progress-bar-label">HTML&amp;CSS - <span>4 years experience</span></label>
            <div class="progress">
                <div style="width: 95%;" class="progress-bar" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
                    <span>95%</span>
                </div>
            </div>
            <label class="progress-bar-label">Javascript - <span>4 years experience</span></label>
            <div class="progress">
                <div style="width: 67%;" class="progress-bar" role="progressbar" aria-valuenow="67" aria-valuemin="0" aria-valuemax="100">
                    <span>67%</span>
                </div>
            </div>
            <label class="progress-bar-label">PHP - <span>1 year experience</span></label>
            <div class="progress">
