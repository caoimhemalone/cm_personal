<div class="name-block">
    <div class="name-block-container">
        <h1><span>Hi, I'm</span>Caoimhe Malone </br>(Keyvah)</h1>
        ...
        <ul class="social">
            ...
            <li><a  target="_blank"href="https://www.linkedin.com/in/caoimhemalone/"><i class="ion-social-linkedin"></i></a></li>
        </ul>
    </div>
</div>
<div class="menu-blocks">
    <div class="about-block menu-block">
        <div class="about-block-container">
            <h2 class="about menu-item">What I've Done</h2>
        </div>
    </div>
