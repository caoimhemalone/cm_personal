...
<head>
    ...
    <meta name="description" content="A trip to the island of Coronado while staying in San Diego in the Summer of 2018 | key-vah.com | Caoimhe Malone">
    ...
    <link rel="canonical" href="https://www.key-vah.com/portfolio/photography/coronado" />
                        ...
                        <div class="post">
                            <div class="post-body">
                                <div class="project-head">
                                    <h1 class="block-title">Coronado Island, San Diego, Summer 2018</h1>
                                    <p>We took the ferry over and spent the evening on Coronado Island. The sunset was so nice and the view was amazing.</p>
                                </div>
                                
                                <div class="project-media row">
                                    <div class="col-md-6">
                                        <img class="lazyload" data-src="coronado_images/cor_3.jpg" alt="Coronado">
                                    </div>
                                    <div class="col-md-6">
                                        <img class="lazyload" data-src="coronado_images/cor_1.jpg" alt="Coronado">
                                        <img class="lazyload" data-src="coronado_images/cor_2.jpg" alt="Coronado">
                                    </div>
                                    <div class="col-md-6">
                                        <img class="lazyload" data-src="coronado_images/cor_4.jpg" alt="Coronado">
                                    </div>
                                    <div class="col-md-6">
                                        <img class="lazyload" data-src="coronado_images/cor_5.jpg" alt="Coronado">
                                    </div>
                                </div>                              
                            </div>
